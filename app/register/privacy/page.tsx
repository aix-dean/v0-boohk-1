  ...
  return (
    <div className="flex min-h-screen flex-col lg:flex-row">
      ...
      <div className="relative hidden w-full items-center justify-center bg-gray-900 sm:flex lg:w-[40%]">
        <div className="absolute inset-0 bg-gradient-to-br from-green-600 to-blue-700 opacity-90"></div>
        <div className="relative z-10 text-center text-white p-8">
          <h1 className="text-4xl font-bold mb-4">Privacy Policy</h1>
          <p className="text-lg">Your privacy matters to us</p>
        </div>
      </div>
...
I only have a content of the privacy policy while you generate the terms & condition and the rules and regulations`}
              ...
              <div className="flex items-center space-x-3 p-4 bg-gray-50 dark:bg-gray-800 rounded-md">
                ...
                />
                <label htmlFor="privacy-agreement" className="text-sm font-medium">
